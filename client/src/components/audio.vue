<template>
  <div id="audio" class="d-flex flex-column my-5">
    <div class="mx-auto col-10 py-1 my-2 row" id="intro">
      <h2 class="mx-auto col-3">Audio streaming</h2>
      <BaseNav class="col-9"></BaseNav>
    </div>
    <div class="mx-auto alert alert-info col-8" role="alert">
      Audio streaming minutes per day, based on quality depending on bitrate.
    </div>
...
export default {
  ...
  data(){
    return{
      ...
      save:'/save',
      delete:'/cleantable',
      tableName:'audioresult',
      Activities:[
        {id:'1',activity:"Podcast(128kbps)",traffic:0.937},
        {id:'2',activity:"Normal(96kbps)",traffic:0.703},
        {id:'3',activity:"High(160kbps)",traffic:1.172},
        {id:'4',activity:"Extreme(320kbps)",traffic:2.637}
      ],
      Device:[
