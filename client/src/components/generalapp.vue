<template>
  <div id="genApp" class="d-flex flex-column my-5">
    <div class="mx-auto col-10 py-1 my-2 row" id="intro">
      <h2 class="mx-auto col-3">Apps Usage Preference</h2>
      <BaseNav class="col-9"></BaseNav>
    </div>
    <div class="mx-auto alert alert-info col-8" role="alert">
      The four ICT activities represent a selection of many apps in daily use.
      <br>
      &nbsp&nbsp<strong>Web browsing:</strong> Browsing data and consulting information based on the web browser.
      <br>
      &nbsp&nbsp<strong>Social Media:</strong> websites and apps specialize in sharing links, short messages, photos or videos.
      <br>
      &nbsp&nbsp<strong>Navigation:</strong> Real-time access to GPS, road conditions, and public transportation information
      <br>
      &nbsp&nbsp<strong>Update&Download:</strong> Update or download software on digital devices
    </div>
    <div class="mx-auto alert alert-warning col-8" role="alert">
      <strong>Note:</strong>
      <br>
      1.Embedded video in web browsing and social media is counted under video streaming.
      <br>
      2.The power consumption of ICT devices can choose different Wh according to your usage.
      <br>
      3.The "Add" button helps you create customized calculating form.
    </div>
...
export default {
  ...
  data(){
    return{
      ...
      save:'/save',
      delete:'/cleantable',
      tableName:'generalresult',
      Activities:[
        {id:'1',activity:"Web browsing",traffic:1},
        {id:'2',activity:"Social media",traffic:0.4},
        {id:'3',activity:"Navigation",traffic:0.1},
        {id:'4',activity:"Updates/Download",traffic:10},
      ],
      Device:[
